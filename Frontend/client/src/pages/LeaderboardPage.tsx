        ...
        <div className="p-6 max-w-3xl mx-auto space-y-6">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 flex items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="font-bold text-white text-sm">Leaderboard participation</p>
                        <p className="text-zinc-500 text-xs">
                            {isPublic ? 'Your profile is visible in the rankings' : 'Your profile is hidden from other players'}
                        </p>
                    </div>
                </div>
            ...
            {!isPublic ? (
                <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-12 flex flex-col items-center justify-center text-center gap-4">
                    ...
                    <h2 className="text-xl font-black text-white">You are learning at your own pace</h2>
                    <p className="text-zinc-400 text-sm max-w-sm">
                        Your profile is hidden from other players. Enable leaderboard participation to see the Hall of Fame.
                    </p>
                </div>
            ) : (
                <>
                    ...
                    <div className="bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden">
                        {isLoading ? (
                            <div className="flex items-center justify-center py-16 gap-3 text-zinc-500">
                                ...
                                <span className="font-bold">Loading rankings...</span>
                            </div>
                        ) : activeTab === 'global' ? (
                            globalData.length === 0 ? (
                                <div className="py-16 text-center text-zinc-500 font-bold">No players yet 👤</div>
                            ) : (
                                    ...
                                    {courseData.map((player, index) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center gap-1.5 text-yellow-400 font-black text-sm bg-yellow-500/10 px-3 py-1.5 rounded-lg">
                                                <Trophy size={14} />
                                                {player.courseXp.toLocaleString()} Course XP
                                            </div>
                                        </li>
                                    ))}
                                </ul>
